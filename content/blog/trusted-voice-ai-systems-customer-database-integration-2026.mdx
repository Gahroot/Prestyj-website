...
- Only **4 of 8 evaluated platforms** (Prestyj, EliseAI, Retell, and one configuration of Vapi) hold SOC 2 Type II _and_ a HIPAA BAA option
...
The distinction matters more than vendors admit. **SOC 2 Type I** is a point-in-time attestation that controls exist. **SOC 2 Type II** is a 6–12 month audit that controls were _operationally effective_ over time. "SOC 2 in progress" is a marketing claim, not a certification — anyone can be "in progress" indefinitely.
