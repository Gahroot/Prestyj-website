...
The per-post cost gets _worse_ as you scale up retainers, not better — because the % allocated to overhead, strategy, and reporting grows faster than the production line.
