...
1. *"Can you walk me through a recent implementation for a company similar to ours?"* — You want specifics: timeline, integration challenges, metrics before and after
2. *"Who specifically builds our agent? What's their background?"* — The answer tells you whether you're getting experienced AI engineers or junior consultants following a template
3. *"What does your first 90 days look like after go-live?"* — Strong providers have a structured post-launch optimization period with weekly check-ins and metric reviews

**On Pricing Transparency:**

4. *"What's included in the monthly fee, and what triggers additional charges?"* — You want a clear breakdown: platform costs, call volume, integration maintenance, optimization hours, support
5. *"What's the total cost including implementation, monthly fees, and any overages for 12 months?"* — If they can't answer this clearly, their pricing model is either complicated or hiding something
6. *"How does pricing change as we scale?"* — Good providers offer volume discounts; great providers help you model the economics of growth
...
7. *"What happens if performance drops? Walk me through your escalation process."* — You want specific SLAs, not vague promises
8. *"How often will we meet to review performance?"* — Weekly for the first month, bi-weekly or monthly after that is the standard for serious providers
9. *"What metrics do you track and report on?"* — Look for business outcomes (conversions, appointments booked, revenue influenced), not just vanity metrics (calls answered, minutes used)
