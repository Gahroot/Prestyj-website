...
The line fee is not the real number — cost per _connected conversation_ is. Worked example for a typical call center outbound line:
...
- **Inbound-only centers.** Branded calling lifts _outbound_ answer rates; inbound caller-ID reputation is a separate product.
