...
4. Calculate `incremental qualified conversations = branded qualified conversations − holdout qualified conversations`.
5. Calculate `cost per incremental qualified conversation = total branded-calling cost ÷ incremental qualified conversations`.
