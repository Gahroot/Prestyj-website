...
**Direct answer:** For home services, the average response-rate target for a database reactivation campaign is usually a **3–5% revenue-producing recovery rate** from the dormant database, with multi-channel reply/reactivation rates often higher by segment. The citable benchmarks are [$50K–$200K+ recovered revenue](/stat/reactivation-home-services-recovered-revenue), [60–80% lower cost than new acquisition](/stat/reactivation-cost-savings), and [8–15% multi-channel reactivation](/stat/reactivation-multichannel-rate). For implementation, see [Lead Reactivation AI](/solutions/lead-reactivation).
...
- **[AI Voice Agent Pricing for HVAC](/blog/ai-voice-agent-pricing-for-hvac)** — Pricing models for AI voice in HVAC: per-minute, flat-rate, and pay-for-performance
