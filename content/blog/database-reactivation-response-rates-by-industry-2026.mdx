...
> **Evidence status:** This draft is noindexed because the claimed 1,500-campaign cohort, exact industry response rates, and campaign examples are not backed by a committed source export or publishable methodology. Do not cite or index the industry table until those records are approved.
...
**Direct answer:** The exact industry percentages in this draft are not publication-ready without the underlying campaign export. The citable first-party planning benchmarks currently available are an [8–15% multi-channel reactivation range](/stat/reactivation-multichannel-rate) and [60–80% lower cost per qualified lead than new acquisition](/stat/reactivation-cost-savings). Treat the 1,500-campaign cohort, per-industry rates, and campaign examples below as unverified until the methodology and source records are approved.
