...
The line fee is not the real number — cost per _connected conversation_ is. Worked example for a typical advisory firm outbound line:
...
- **Inbound-only client service lines.** Branded calling lifts _outbound_ answer rates; inbound caller-ID reputation is a separate product.
