...
Canonical home: <https://prestyj.com/data>
GitHub mirror: <https://github.com/Gahroot/prestyj-statistics-dataset>
...
Attribution to Prestyj (<https://prestyj.com>) required when using this data.
