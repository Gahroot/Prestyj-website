...
target_url: https://www.housingwire.com
channel: email
...
For your coverage specifically: Real-estate-specific slice: ISA/lead response speed, AI sales-agent adoption, and what 5-minute response actually does to qualification rates.
