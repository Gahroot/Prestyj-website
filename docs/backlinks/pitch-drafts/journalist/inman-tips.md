...
bucket: journalist
name: "Inman"
target_url: https://www.inman.com
channel: email
...
For your coverage specifically: Speed-to-lead data for brokerages — the 5-minute/30-minute curve and how few teams actually respond in the window.
