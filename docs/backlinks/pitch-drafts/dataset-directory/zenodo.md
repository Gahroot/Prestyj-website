...
---
## Zenodo (CERN) — dataset submission checklist

**Submit at:** https://zenodo.org/uploads/new
**Prepared bundle:** docs/oss-dataset/distributions/zenodo
**Role:** Open research-data repository that mints a permanent DOI on upload.
**DOI minted:** yes
...
### Steps
1. Sign in / create an account at https://zenodo.org.
2. Start a new dataset upload.
3. Paste metadata from the bundle's metadata file (docs/oss-dataset/distributions/zenodo).
