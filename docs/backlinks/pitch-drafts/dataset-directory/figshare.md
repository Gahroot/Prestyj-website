...
**Submit at:** https://figshare.com/account/projects
**Prepared bundle:** docs/oss-dataset/distributions/figshare
**Role:** Research-data repository; permanent DOI on publish.
**DOI minted:** yes
...
### Steps
1. Sign in / create an account at https://figshare.com.
2. Start a new dataset upload.
3. Paste metadata from the bundle's metadata file (docs/oss-dataset/distributions/figshare).
