...
target_url: https://data.mendeley.com
channel: data-repository
doi: true
status: drafted
generated_at: 2026-06-04T16:38:58.406Z
---
## Mendeley Data (Elsevier) — dataset submission checklist

**Submit at:** https://data.mendeley.com
**Prepared bundle:** docs/oss-dataset/distributions/mendeley
**Role:** DataCite-indexed research-data repository; DOI on publish; appears in Google Dataset Search.
**DOI minted:** yes
...
### Steps
1. Sign in / create an account at https://data.mendeley.com.
2. Start a new dataset upload.
3. Paste metadata from the bundle's metadata file (docs/oss-dataset/distributions/mendeley).
