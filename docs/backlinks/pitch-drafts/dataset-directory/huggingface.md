...
---
## Hugging Face Datasets — dataset submission checklist

**Submit at:** https://huggingface.co/new-dataset
**Prepared bundle:** docs/oss-dataset/distributions/huggingface
**Role:** ML-community dataset discovery; CSV absorbed into the dataset viewer.
**DOI minted:** no
...
3. Paste metadata from the bundle's metadata file (docs/oss-dataset/distributions/huggingface).
