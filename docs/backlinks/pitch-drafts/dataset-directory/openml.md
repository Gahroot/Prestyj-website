...
name: "OpenML"
target_url: https://www.openml.org/new-data
...
**Submit at:** https://www.openml.org/new-data
**Prepared bundle:** docs/oss-dataset/distributions/openml
**Role:** ML benchmark catalog; CSV cleanly absorbed.
**DOI minted:** no
...
### Steps
1. Sign in / create an account at https://www.openml.org.
2. Start a new dataset upload.
3. Paste metadata from the bundle's metadata file (docs/oss-dataset/distributions/openml).
