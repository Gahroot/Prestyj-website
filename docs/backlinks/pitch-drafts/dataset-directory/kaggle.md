...
---
## Kaggle Datasets — dataset submission checklist

**Submit at:** https://www.kaggle.com/datasets
**Prepared bundle:** docs/oss-dataset/distributions/kaggle
**Role:** Data-science community discovery; metadata pre-configured in the bundle.
**DOI minted:** no
...
### Steps
1. Sign in / create an account at https://www.kaggle.com.
2. Start a new dataset upload.
3. Paste metadata from the bundle's metadata file (docs/oss-dataset/distributions/kaggle).
