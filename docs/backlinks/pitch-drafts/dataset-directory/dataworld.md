...
---
## data.world — dataset submission checklist

**Submit at:** https://data.world/new
**Prepared bundle:** docs/oss-dataset/distributions/dataworld
**Role:** Open-data community; public dataset with linked sources.
**DOI minted:** no
...
### Steps
1. Sign in / create an account at https://data.world.
2. Start a new dataset upload.
3. Paste metadata from the bundle's metadata file (docs/oss-dataset/distributions/dataworld).
