...
| O5 | Industry-specific lead magnet | **Live.** `/lead-magnet` hub + 4 magnets: Brokerage Playbook, Roofing 24/7 Lead Response Playbook, QualVol Content Playbook, Reactivate Dead Leads (live AI call — this one is a *demo*, not a PDF). | **Live.** `/lead-magnet/{brokerage,roofing,qualvol,reactivate-leads}-playbook`. |
...
- Lowest *plan* is **$3,997 setup + $1,997/mo** (Starter).
...
| **Friction** (FR) — *inverted; higher = less friction* | 7-step form, scheduling required, app review | One field, instant gratification |
...
### O3 — "Steal our top-performing ad" swipe file *(hypothetical)*
...
### O4 — Free competitor teardown *(hypothetical, personalized 1:1)*
...
- **DB 9.** Walkthrough *is* a soft demo. Conversion to paid is the highest in the bracket.
...
- **PV 6.** PDF playbooks are commodity. Exception: the `/lead-magnet/reactivate-leads` *live AI call* offer — that's an 8+.
...
- **DB 5.** PDF readers convert poorly to demos. The live-AI-call variant is the exception (it qualifies *during* the magnet).

### O6 — Guaranteed-leads trial *(hypothetical)*
...
- **DB 9.** Trial *is* the close. Lead → trial-activated is effectively the demo-book equivalent.
...
**Winner: O6 Guaranteed Trial** — *but flagged as operationally risky.*
...
|---|---|---|---|
| 🥇 1 | **O1 — Founding Cohort** | 7.4 | Live. Cap at 5 spots is both the scarcity hook *and* the ceiling — once full, the offer dies and you need a Cohort 2. |
...
**Role.** Always-on, SEO-friendly, retargeting backbone. Calculator results page is the natural place to send paid traffic that *isn't ready to apply yet*.
