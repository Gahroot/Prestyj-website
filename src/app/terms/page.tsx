          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                behalf of our clients to facilitate sales and service bookings on behalf of clients.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4 leading-relaxed">
                ...
                <a href="mailto:support@prestyj.com" className="text-primary hover:underline">
                  support@prestyj.com
                </a>{" "}
                with at least <strong className="text-foreground">14 days&apos; notice</strong>{" "}
                before your next monthly billing date. Cancellation stops future monthly charges;
                fees already paid for the current billing period are non-refundable, and you retain
              ...
              <p className="text-muted-foreground mb-4 leading-relaxed">
                ...
                written guarantee (for example, a documented go-live SLA in your signed agreement)
                entitles you to a setup-fee refund. The applicable terms of any such guarantee are
                governed by your signed order form or service agreement, which controls in the event
                of any conflict with these Terms.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Prestyj does not offer a general money-back guarantee on monthly subscription fees.
                Any refund outside of a written guarantee is granted at Prestyj&apos;s sole
