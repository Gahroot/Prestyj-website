    ...
    <>
      ...
      <main className="pt-28 pb-20 sm:pt-36">
        <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert prose-lg prose-headings:font-heading prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-primary prose-strong:text-foreground mt-10 max-w-none">
            <MDXContent />
          </div>
