...
export default function RoofersFreeAdsPage() {
  const pageUrl = "https://prestyj.com/get-ads/roofers";
    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Batch Video Ads for Roofers", url: pageUrl },
        ]}
      />
      <SafeJsonLd
        data={{
          ...
          "@type": "Service",
          name: "Batch Video Ads for Roofers",
          description:
            "Batch scripted video ads for roofing companies. 24-hour turnaround from your footage. Storm season ready with ad setup, landing page, and AI lead response.",
