...
export const metadata: Metadata = {
  ...
  keywords: [
    "free video ads for law firms",
    "law firms advertising",
    "video ads for law firms",
    "law firms marketing",
    "free facebook ads law firms",
    "law firms lead generation",
  ],
  openGraph: {
    title: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
    type: "website",
    url: "https://prestyj.com/free-ads/law-firms",
  },
  alternates: {
    canonical: "https://prestyj.com/free-ads/law-firms",
  },
};
