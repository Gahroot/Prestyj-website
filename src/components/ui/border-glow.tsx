...
function parseHSL(hslStr: string): { h: number; s: number; l: number } {
  ...
  if (!match) return { h: 250, s: 71, l: 62 };
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  innerClassName,
  edgeSensitivity = 30,
  // Primary purple: #7058e3 → hsl(250, 71%, 62%)
  glowColor = '250 71 62',
  ...
  coneSpread = 25,
  animated = false,
  // Theme: primary purple, mint, light purple
  colors = ['#7058e3', '#5ee5b3', '#a78bfa'],
  fillOpacity = 0.5,
  innerStyle,
  style: externalStyle,
  ...rest
  ...
  return (
    ...
    >
      ...
      <div className={cn('border-glow-inner', innerClassName)} style={innerStyle}>
        {children}
      </div>
    </div>
  );
