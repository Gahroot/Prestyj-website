...
export const videoAdsForContractors: BestForPageContent = {
  slug: "video-ads-for-contractors",
  niche: {
    name: "Video Ads for Contractors",
  ...
  meta: {
    title: "300 Contractor Video Ads in 24 Hours (From $1,497)",
    description:
    ...
    keywords: [
      ...
      "general contractor video marketing",
      "kitchen remodel facebook ads",
      "design build marketing",
      "contractor lead generation video",
      "remodeler ad creative",
      "done for you contractor ads",
    ],
  },
  hero: {
    badge: "Batch Video Ads for Contractors",
    headline: "Stop Competing on Price With Every Other",
    headlineAccent: "Handyman in Your Zip Code.",
    subheadline:
      "Kitchen remodels, whole-home renovations, ADUs, primary-suite additions — these are six-figure decisions homeowners take months to make. The contractor who shows up in their feed with specific, design-led, trust-building video ads wins the bid before the competition ever gets called. Prestyj turns 20 minutes of footage into 300–1,000 scripted video ads in 24 hours.",
  },
  whyBestFor: [
    {
      icon: "Home",
      title: "Remodeling is a trust decision, not a bid decision",
      description:
        "Homeowners let contractors into their home, kitchen, bathroom, and often their savings for 3–9 months. They don't pick the lowest bid — they pick the contractor they trust not to disappear or mess up. Video ads featuring you on camera, job-site walkthroughs, and finished-project tours build that trust before the first meeting. Yard signs and Google LSAs can't do this.",
    },
    {
      icon: "Target",
      title: "Design-build vs traditional bid needs completely different creative",
      description:
        "Design-build firms sell a premium end-to-end experience that requires educational, aspirational creative — showroom tours, designer interviews, 'why we don't low-bid' positioning. Traditional-bid contractors compete on schedule availability, specific project specialization, and referral credibility. One generic 'home remodeling' ad speaks to neither audience. Batch lets you ship both tracks in one engagement.",
    },
    {
      icon: "Users",
      title:
    ...
    {
      icon: "DollarSign",
      title: "One kitchen remodel pays for the batch 30 times over",
      description:
        "Average kitchen remodel: $45,000–$90,000. Whole-home renovation: $150,000–$500,000+. ADU build: $200,000–$400,000+. A $1,497 batch that signs even one additional project pays back 30–300x. The creative assets keep generating leads for 12+ months after the one-time cost.",
    },
    {
      icon: "Zap",
      title: "Your finished-project photos and job-site footage are an untapped ad goldmine",
      description:
        "Most contractors have hundreds of hours of drone footage, before-and-afters, time-lapse installs, and finished-project walk-throughs collecting dust on their phone. Batch production turns that existing library into 200+ ad variants paired with scripted hooks — instead of sitting unused in a Google Drive folder.",
    },
  ],
  painPoints: [
    {
    ...
    {
      problem: "You have gorgeous project photos but Instagram posts get 12 likes and no leads",
      solution:
  ...
  comparison: {
    headers: ["Feature", "Prestyj Batch Video Ads", "Hiring an Agency or Doing It Yourself"],
    rows: [
      {
        feature: "Ad variations delivered",
        prestyj: "300–1,000 unique variations",
        others: "4–6 ads per month agency, 0–2 DIY",
      },
      {
        feature: "Cost structure",
        prestyj: "One-time $1,497 / $2,497 / $3,997",
        others: "$2,000–$5,000/month on retainer",
      },
      {
        feature: "Time commitment from you",
        prestyj: "One 15–20 minute shoot",
        others: "Weekly strategy calls, shoot days, revision cycles",
      },
      {
        feature: "Design-build vs bid positioning",
        prestyj: "Both tested in parallel",
        others: "Whichever the agency is comfortable with",
      },
      {
        feature: "Showroom-visit optimized funnel",
        prestyj: "Dedicated track for showroom conversion",
        others: "Usually 'request a quote' generic CTA",
      },
      {
        feature: "Use of your existing project footage",
        prestyj: "Integrated into 100+ variants with scripted hooks",
        others: "Sits in Google Drive unused",
      },
      {
        feature: "Turnaround",
        prestyj: "24 hours after footage submission",
        others: "3–6 week production cycle per set",
      },
    ],
  },
  faq: [
    {
      question: "Will Facebook leads actually convert into six-figure projects?",
      answer:
    ...
    {
      question: "What's the shot list — do I need a professional videographer?",
      answer:
        "iPhone selfie-style is sufficient for the 'you on camera' portion (8–12 scripted segments of 30–60 seconds each). For job-site and finished-project B-roll, anything you already have works — phone walkthroughs, drone footage, time-lapses. We don't need Sony FX9 cinema quality. We need real-looking content that feels native to the feed. Polished production actually underperforms on paid social because it reads as 'ad' instead of 'content.'",
    },
    {
      question: "My state has strict contractor advertising rules. How does compliance work?",
      answer:
