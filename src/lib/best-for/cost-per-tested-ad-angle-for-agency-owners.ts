...
// Vertical: Agency Owners · Angle: cost per tested ad angle (pricing math)
export const costPerTestedAdAngleForAgencyOwners: BestForPageContent = {
  slug: "cost-per-tested-ad-angle-for-agency-owners",
  niche: {
    name: "Cost Per Tested Ad Angle for Agency Owners",
  ...
  meta: {
    ...
    keywords: [
      "cost per ad angle agency-owners",
      "cost per tested creative agency-owners",
      "agency owners ad creative pricing",
      "video ad pricing for agency-owners",
      "hidden costs of agency-owners video ads",
      "agency owners creative testing cost",
      "ad angle testing pricing agency-owners",
      "cost per fresh creative agency-owners",
    ],
  },
  hero: {
    badge: "Pricing Math for Agency Owners",
    headline: "What Does It Actually Cost to Test One Ad Angle for Agency Owners?",
    headlineAccent: "Headline Price ≠ Tested Cost.",
    subheadline:
      "Most agency owners compare ad creative on per-video price. That's the wrong unit. The unit that matters is cost per tested angle — the fully-loaded cost to ship enough variations of one hook to actually learn whether it converts. Agency math, freelancer math, in-house math, and batch math give wildly different answers. Here is the breakdown.",
  },
  whyBestFor: [
    {
      icon: "DollarSign",
    ...
    },
    {
      ...
      description:
        "Even a winning angle dies inside 14-21 days as frequency builds. Cost per tested angle has to include the refresh — you do not test once, you test, ship, refresh, repeat. The hidden cost of skipping your own marketing is concentration risk — one client churn becomes a survival event because you never built creative volume to backfill.",
    },
    {
      icon: "Clock",
      title: "Time-to-learning is part of the cost",
      description:
        "An agency angle takes 14-30 days to ship 1-2 videos. A batch angle ships in 24 hours with 100 variations. The opportunity cost of waiting 30 days to start a test is invisible on an invoice but very real in your P&L — especially for agency owners where $3,000-$15,000/month in retainer per landed client.",
    },
    {
      icon: "Filter",
      title: "Most 'video ad pricing' calculators ignore script research",
      description:
        "If you give a freelancer a script, that's one cost. If you ask them to research your vertical and write the script, you've doubled the price and added 2 weeks. Batch pricing includes vertical-researched scripts written for Agency Owners pain points specifically. That's bundled, not extra.",
    },
  ],
  painPoints: [
    {
  ...
  comparison: {
    ...
    rows: [
      ...
      },
      {
        ...
        prestyj: "≈$500",
        others: "$2,000-$5,000 in subscription + scripting time",
      },
      {
      ...
      },
      {
        ...
        prestyj: "$22-$48 cost-per-discovery-call",
        others: "$120-$300 (when you ship at all)",
      },
    ],
  },
  faq: [
    ...
    {
      question: "What about agency owners who only need to test 1 angle?",
      answer:
        "Then the 300-ad / 3-angle tier at $1,497 still wins on per-angle math (≈$500/angle). But realistically, agency owners almost never need only one angle. Different sub-audiences, different offers, different funnel stages, different times of year all need different hooks. Most agency owners land at 5-10 angles within their first quarter on paid social.",
    },
    {
      question: "Where does the fatigue tax come into the math?",
      answer:
        "The hidden cost of skipping your own marketing is concentration risk — one client churn becomes a survival event because you never built creative volume to backfill. Cost per tested angle has to be re-paid every 30-60 days because winning angles fatigue. Batch math: a refresh batch is the same flat fee. Agency math: every refresh resets the retainer clock. Over 12 months the cost gap widens dramatically — most agency owners who run continuous paid social see batch save 60-85% of fully-loaded creative cost over a calendar year.",
    },
  ],
  cta: {
    headline: "Run the Math for Agency Owners: ≈$500 Per Tested Angle.",
    subheadline:
