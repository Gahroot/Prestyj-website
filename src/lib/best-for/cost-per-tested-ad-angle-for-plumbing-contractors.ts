...
// Vertical: Plumbing Contractors · Angle: cost per tested ad angle (pricing math)
export const costPerTestedAdAngleForPlumbingContractors: BestForPageContent = {
  slug: "cost-per-tested-ad-angle-for-plumbing-contractors",
  niche: {
    name: "Cost Per Tested Ad Angle for Plumbing Contractors",
    shortName: "Plumbing",
    description:
      "Pricing math for residential and commercial plumbing contractors running $1M-$15M/year with 3-30 trucks who need to know the true unit cost of testing a new ad angle — not the headline price of a video, but the fully-loaded cost to run, learn, and decide on one positioning hypothesis.",
  },
  meta: {
    title: "Cost Per Tested Ad Angle for Plumbing Contractors (2026 Math) | PRESTYJ",
    description:
      "What does it actually cost to test one ad angle for Plumbing? Agency: $4K-$15K. Freelancer: $2K-$8K. Batch: ≈$500. Full pricing math, fatigue tax, and hidden costs broken down.",
    keywords: [
      "cost per ad angle plumbing-contractors",
      "cost per tested creative plumbing-contractors",
      "plumbing ad creative pricing",
      "video ad pricing for plumbing-contractors",
      "hidden costs of plumbing-contractors video ads",
      "plumbing creative testing cost",
      "ad angle testing pricing plumbing-contractors",
      "cost per fresh creative plumbing-contractors",
    ],
  },
  hero: {
    badge: "Pricing Math for Plumbing",
    headline: "What Does It Actually Cost to Test One Ad Angle for Plumbing?",
    headlineAccent: "Headline Price ≠ Tested Cost.",
    subheadline:
      "Most plumbing compare ad creative on per-video price. That's the wrong unit. The unit that matters is cost per tested angle — the fully-loaded cost to ship enough variations of one hook to actually learn whether it converts. Agency math, freelancer math, in-house math, and batch math give wildly different answers. Here is the breakdown.",
  },
  whyBestFor: [
    {
      icon: "DollarSign",
    ...
    },
    {
      ...
      description:
        "Even a winning angle dies inside 14-21 days as frequency builds. Cost per tested angle has to include the refresh — you do not test once, you test, ship, refresh, repeat. The hidden cost is mismatched-intent traffic — generic plumbing ads pull tire-kickers while specific 'water-heater replacement' or 'slab leak' ads pull buyers.",
    },
    {
      icon: "Clock",
      title: "Time-to-learning is part of the cost",
      description:
        "An agency angle takes 14-30 days to ship 1-2 videos. A batch angle ships in 24 hours with 100 variations. The opportunity cost of waiting 30 days to start a test is invisible on an invoice but very real in your P&L — especially for plumbing where $220 service call → $4,500-$28,000 repipe / sewer / water-heater install.",
    },
    {
      icon: "Filter",
      title: "Most 'video ad pricing' calculators ignore script research",
      description:
        "If you give a freelancer a script, that's one cost. If you ask them to research your vertical and write the script, you've doubled the price and added 2 weeks. Batch pricing includes vertical-researched scripts written for Plumbing pain points specifically. That's bundled, not extra.",
    },
  ],
  painPoints: [
    {
  ...
  comparison: {
    headers: ["Cost Component", "Prestyj Batch (500 ads / 5 angles)", "Typical Fiverr Video Editors Path"],
    rows: [
      {
      ...
      },
      {
        ...
        prestyj: "≈$500",
        others: "$9,000-$15,000 to assemble enough variations",
      },
      {
      ...
      },
      {
        ...
        prestyj: "$18-$44 per booked appointment",
        others: "$95-$210 per aggregator lead (sold to 3 competitors)",
      },
    ],
  },
  faq: [
    ...
    {
      question: "What about plumbing who only need to test 1 angle?",
      answer:
        "Then the 300-ad / 3-angle tier at $1,497 still wins on per-angle math (≈$500/angle). But realistically, plumbing almost never need only one angle. Different sub-audiences, different offers, different funnel stages, different times of year all need different hooks. Most plumbing land at 5-10 angles within their first quarter on paid social.",
    },
    {
      question: "Where does the fatigue tax come into the math?",
      answer:
        "The hidden cost is mismatched-intent traffic — generic plumbing ads pull tire-kickers while specific 'water-heater replacement' or 'slab leak' ads pull buyers. Cost per tested angle has to be re-paid every 30-60 days because winning angles fatigue. Batch math: a refresh batch is the same flat fee. Agency math: every refresh resets the retainer clock. Over 12 months the cost gap widens dramatically — most plumbing who run continuous paid social see batch save 60-85% of fully-loaded creative cost over a calendar year.",
    },
  ],
  cta: {
    headline: "Run the Math for Plumbing: ≈$500 Per Tested Angle.",
    subheadline:
      "300-1,000 scripted ads, vertical-researched for plumbing, your real face, 24-hour delivery. Flat fee from $1,497 — the only pricing model where per-tested-angle math actually works.",
