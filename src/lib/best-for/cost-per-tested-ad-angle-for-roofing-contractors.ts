...
// Vertical: Roofing Contractors · Angle: cost per tested ad angle (pricing math)
export const costPerTestedAdAngleForRoofingContractors: BestForPageContent = {
  slug: "cost-per-tested-ad-angle-for-roofing-contractors",
  niche: {
    name: "Cost Per Tested Ad Angle for Roofing Contractors",
    shortName: "Roofing",
    description:
      "Pricing math for residential roofing contractors with 3-100 crews chasing storm and retail-reroof demand who need to know the true unit cost of testing a new ad angle — not the headline price of a video, but the fully-loaded cost to run, learn, and decide on one positioning hypothesis.",
  },
  meta: {
    title: "Cost Per Tested Ad Angle for Roofing Contractors (2026 Math) | PRESTYJ",
    description:
      "What does it actually cost to test one ad angle for Roofing? Agency: $4K-$15K. Freelancer: $2K-$8K. Batch: ≈$500. Full pricing math, fatigue tax, and hidden costs broken down.",
    keywords: [
      "cost per ad angle roofing-contractors",
      "cost per tested creative roofing-contractors",
      "roofing ad creative pricing",
      "video ad pricing for roofing-contractors",
      "hidden costs of roofing-contractors video ads",
      "roofing creative testing cost",
      "ad angle testing pricing roofing-contractors",
      "cost per fresh creative roofing-contractors",
    ],
  },
  hero: {
    badge: "Pricing Math for Roofing",
    headline: "What Does It Actually Cost to Test One Ad Angle for Roofing?",
    headlineAccent: "Headline Price ≠ Tested Cost.",
    subheadline:
      "Most roofing compare ad creative on per-video price. That's the wrong unit. The unit that matters is cost per tested angle — the fully-loaded cost to ship enough variations of one hook to actually learn whether it converts. Agency math, freelancer math, in-house math, and batch math give wildly different answers. Here is the breakdown.",
  },
  whyBestFor: [
    {
      icon: "DollarSign",
    ...
    },
    {
      ...
      description:
        "Even a winning angle dies inside 14-21 days as frequency builds. Cost per tested angle has to include the refresh — you do not test once, you test, ship, refresh, repeat. The hidden cost is missed storm windows — the gold rush collapses inside 14 days and a retainer agency cannot ship event-specific creative in time.",
    },
    {
      icon: "Clock",
      title: "Time-to-learning is part of the cost",
      description:
        "An agency angle takes 14-30 days to ship 1-2 videos. A batch angle ships in 24 hours with 100 variations. The opportunity cost of waiting 30 days to start a test is invisible on an invoice but very real in your P&L — especially for roofing where $12,000-$40,000 per reroof (insurance or retail).",
    },
    {
      icon: "Filter",
      title: "Most 'video ad pricing' calculators ignore script research",
      description:
        "If you give a freelancer a script, that's one cost. If you ask them to research your vertical and write the script, you've doubled the price and added 2 weeks. Batch pricing includes vertical-researched scripts written for Roofing pain points specifically. That's bundled, not extra.",
    },
  ],
  painPoints: [
    {
  ...
  comparison: {
    headers: ["Cost Component", "Prestyj Batch (500 ads / 5 angles)", "Typical In-House Marketing Hire Path"],
    rows: [
      {
      ...
      },
      {
        ...
        prestyj: "$15-$45 per booked inspection",
        others: "$80-$200 per canvasser-generated lead (fully loaded labor)",
      },
    ],
  },
  faq: [
    ...
    {
      question: "What about roofing who only need to test 1 angle?",
      answer:
        "Then the 300-ad / 3-angle tier at $1,497 still wins on per-angle math (≈$500/angle). But realistically, roofing almost never need only one angle. Different sub-audiences, different offers, different funnel stages, different times of year all need different hooks. Most roofing land at 5-10 angles within their first quarter on paid social.",
    },
    {
      question: "Where does the fatigue tax come into the math?",
      answer:
        "The hidden cost is missed storm windows — the gold rush collapses inside 14 days and a retainer agency cannot ship event-specific creative in time. Cost per tested angle has to be re-paid every 30-60 days because winning angles fatigue. Batch math: a refresh batch is the same flat fee. Agency math: every refresh resets the retainer clock. Over 12 months the cost gap widens dramatically — most roofing who run continuous paid social see batch save 60-85% of fully-loaded creative cost over a calendar year.",
    },
  ],
  cta: {
    headline: "Run the Math for Roofing: ≈$500 Per Tested Angle.",
    subheadline:
      "300-1,000 scripted ads, vertical-researched for roofing, your real face, 24-hour delivery. Flat fee from $1,497 — the only pricing model where per-tested-angle math actually works.",
