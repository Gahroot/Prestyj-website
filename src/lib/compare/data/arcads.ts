...
export const arcadsCompareData: ComparePageData = createComparePage({
  ...
  features: [
    ...
    {
      feature: "Risk of 'AI UGC' disclosure / platform flagging",
      prestyj: "None",
      competitor: "Growing — Meta + TikTok are tightening",
    },
    {
  ...
  whySwitch: {
    ...
    description:
      "Arcads is a great tool. It is not a great fit for businesses whose owner IS the brand.",
    reasons: [
      {
        icon: "Users",
