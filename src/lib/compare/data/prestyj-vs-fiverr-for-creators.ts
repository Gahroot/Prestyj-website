...
export const creatorsVsFiverrForCompareData: ComparePageData = createComparePage({
  ...
  proprietaryData: {
    ...
    intro:
      "Creators often need proof before they can justify a bigger launch, sponsorship funnel, or product push. These figures show why isolated freelance deliverables can look affordable while still leaving the creator short on statistically useful tests.",
    stats: [
      {
        statId: "batch-video-pilot-setup-cost",
        analysis:
          "A fixed pilot price gives creators a defined experiment rather than a series of disconnected gig orders. That matters when the goal is to learn which offers, hooks, or audience segments deserve more spend before scaling.",
      },
      {
        statId: "bva-small-batch-zero-winner-risk",
        analysis:
          "Small batches feel safe because the invoice is limited, but they can easily end with no signal. For creators, that means wasted launch time and ambiguous feedback instead of a clear decision about the next content angle.",
      },
      {
        statId: "ugc-marketplace-hidden-cost-percent",
        analysis:
          "Marketplace work often expands through revisions, usage questions, coordination, and editing gaps after the headline price is accepted. A creator comparing Fiverr to Prestyj should account for that operational drag, not just the first visible quote.",
      },
    ],
    footnote:
